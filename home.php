...
<!-- CONTENIDO ÚNICO DEL PORTAL -->
<main class="portal-content">
        <h1>PORTAL</h1>
        <h2 class="h4">Ideas para un cambio de paradigma</h2>
        <ul class="portal__categories-nav">
            <a href="#" class="portal__last-entries-category"><li><h3 class="h5">ÚLTIMAS ENTRADAS</h3></li></a>
            <span class="h5">/</span>
            <a href="/home.html"><li><h3 class="h5">NOTÍCIAS</h3></li></a>
            <span class="h5">/</span>
            <a href="/home.html"><li><h3 class="h5">ARTÍCULOS</h3></li></a>
            <span class="h5">/</span>
            <a href="/home.html"><li><h3 class="h5">RESEÑAS</h3></li></a>
        </ul>
    ...
    <section class="last-entries-section">        
        ...
        <div class="last-entries-section__cards">
            ...
            <div class="last-entries-section__card">
                ...
                <span class="card__author attribute">por Javier Adrián</>                    
            </div>        
    ...
    <p class="h2-serif-italic">¿Te gusta nuestro contenido? Nuestro proyecto se sustenta gracias a tu contribución. Adquiere una camiseta exclusiva diseñada por un artista y sé parte de nuestra comunidad.  </p>

    <div class="portal-content__shop-link"><a href="tienda.html" class="h5">VISITAR TIENDA</a></div>
